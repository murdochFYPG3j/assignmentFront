angular.module('was-admin').directive("ngTextTruncate", function ($compile, ValidationServices, CharBasedTruncation, WordBasedTruncation) {
        return {
            restrict: "A",
            scope: {
                text: "=ngTextTruncate",
            ...
            link: function ($scope, $element, $attrs) {
                ...
                $scope.$watch("text", function () {
                    $element.empty();  
                    if($scope.text=='null'|| $scope.text== null){
                        $scope.text=' ';
                    }
